...
const Contact = () => {
    return (
        <div name = 'contact' className='flex justify-center items-center h-screen w-full bg-[#0a192f] p-4'>
            <form method='POST' action='https://getform.io/f/ebpwweva'  className=" w-full max-w-[600px] text-gray-300 flex flex-col ">
                <div className="pb-4">
                    <p className='inline border-b-2 border-yellow-500 text-4xl font-bold mx-auto' >Contact</p>
                    <p className='py-5' >\\\ Submit the form below or send me mail on : <span className='text-green-400'>saichandbandi3@gmail.com</span></p>
                </div>
