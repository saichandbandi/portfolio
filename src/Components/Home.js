...
const [Name]= useTypewriter({
 words:["Python Developer","Data Analyst"],
  loop : true,
  typeSpeed : [70], 
  delaySpeed: [1000],
  deleteSpeed : [50]
    ...
    <div name="home" className="h-screen w-full] bg-[#0a192f]" >
      ...
      <div className="h-full max-w-[1000px] flex flex-col justify-center mx-auto px-8 text-white">
        ...
        <p className="max-w-[700px] text-[#8892b0] py-4">
          I’m currently learning Machine Learning & Deep Learning  with a specialization in
          Data Science. | In love with the coding challenges and hands-on
          projects. getting ready to take on
