...
const Navbar = () => {
    ...
    return (
        <div className=" fixed  flex justify-between items-center px-4 mx-auto h-20 border-b-[1px]  bg-[#0a192f] w-full    ">
            ...
            <h1 className="text-rose-300" >SAI...</h1>
            ...
            <div className=" hidden lg:flex fixed left-0 top-[36%] text-white">
                ...
                <ul className="">
                    <li className=" px-4 flex w-[160px] h-[60px] justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-blue-600">
                        <a className="flex justify-between items-center w-full text-gray-300" href="https://www.linkedin.com/in/sai-chand-42684122b?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="__blank">Linkedin  <FaLinkedin size={"30px"} /></a>
                    </li>
                    <li className="px-4 flex w-[160px] h-[60px] justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#333333]">
                        <a className="flex justify-between items-center w-full text-white" href="https://github.com/saichandbandi/saichandbandi" target="__blank">GitHub  <FaGithub size={"30px"} /></a>
                    </li>
                    <li className=" px-4 flex w-[160px] h-[60px] justify-between items-center ml-[-100px] hover:ml-[-10px] duration-300 bg-[#6fc2b0]">
                        <a className="flex justify-between items-center w-full text-white" href="mailto:saichandbandi3@gmail.com?subject=SweetWords&body=Please send me Your message here!">Gmail<HiOutlineMail size={"30px"} /></a>
                    </li>
